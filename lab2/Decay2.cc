...
vector<TLorentzVector> Decay2::random_p4_pair(){
    ...
    TVector3 p3_2 = -p3_1; //being in the com frame the second one is opposite

    TLorentzVector p4_1,p4_2; //pair of 4-momenta to be returned
    p4_1.SetVect(p3_1);
    p4_1.SetE(sqrt(p3_1*p3_1 + m1_*m1_)); //4 momenta of the first particle
    p4_2.SetVect(p3_2);
    p4_2.SetE(sqrt(p3_2*p3_2 + m2_*m2_)); //4 momenta of the second particle
